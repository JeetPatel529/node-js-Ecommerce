...
<template>
  <div
    class="rounded-lg px-2.5 py-2 flex items-center justify-between w-full bg-[#F7F9FB] dark:bg-black-100"
  >
...
<style scoped>
button {
  @apply size-7 flex items-center justify-center rounded-lg;
}
...
input {
  @apply outline-none border-none text-base;
}
</style>
